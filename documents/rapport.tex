...
\begin{algorithm}[H]
	...
	\begin{algorithmic}[1]
		...
		\Require $he_{oppo}$ la demie-arête d'où l'on vient, opposée à la demie-arête où l'on va
...
L'algorithme précédent a conduit à la supression de faces dans l'enveloppe $E$. La reconstruction consiste à construire un triangle entre chaques demie-arêtes de la bordure de $E$ et le point extrême $p_{sel}$. La bordure est obtenue en un temps linéaire, par parcours et récupération des demie-arêtes de $E$ qui sont des demie-arêtes de bordure ($he.opposite == -1$).
